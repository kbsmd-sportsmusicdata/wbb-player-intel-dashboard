...
- **Primary deliverable:** Interactive player intel dashboard
...
- The interactive dashboard also uses runtime presentation dependencies, including Google Fonts, Chart.js CDN assets, and ESPN-hosted logos or headshots.
